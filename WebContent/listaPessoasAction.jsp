				...
				<c:forEach var="pessoa" items="${listaPessoas}">
					<tr>
						...
						<td><a class="btn btn-sm btn-info"
							href="pessoa?action=verPessoa&id=${pessoa.id}"> <i
								class="fas fa-search"></i>
						</a> | <a class="btn btn-sm btn-primary"
							href="pessoa?action=editPessoa&id=${pessoa.id}"> <i
								class="fas fa-edit"></i>
						</a> | <a onclick="deletePessoa(${pessoa.id});"
							class="btn btn-sm btn-danger"
							href="pessoa?action=delPessoa&id=${pessoa.id}"> <i
